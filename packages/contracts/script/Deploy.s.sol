...
contract Deploy is Script {
    ...
    function _deploy(address deployer) internal {
        ...
        aArr[0] = vm.envAddress("AAVE_ADDR");
        address[] memory rArr = new address[](3);
        rArr[0] = vm.envAddress("U2_ADDR");
        rArr[1] = vm.envAddress("U3_ADDR");
        rArr[2] = vm.envAddress("CRV_ADDR");
        address[] memory tArr = new address[](5);
        tArr[0] = vm.envAddress("WETH_ADDR");
        tArr[1] = vm.envAddress("USDC_ADDR");
        tArr[2] = vm.envAddress("USDT_ADDR");
        tArr[3] = vm.envAddress("DAI_ADDR");
        tArr[4] = vm.envAddress("WBTC_ADDR");
